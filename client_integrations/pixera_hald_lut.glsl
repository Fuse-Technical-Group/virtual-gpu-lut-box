...
// Generated by build_shaders.py on 2025-10-02 17:54:12 UTC
// Source template: pixera_hald_lut.template.glsl
// Version: 1.0.0
//
// To modify this shader, edit the source files in client_integrations/src/:
//   - hald_lut_core.glsl (shared interpolation functions)
//   - pixera_hald_lut.template.glsl (platform-specific wrapper)
//
