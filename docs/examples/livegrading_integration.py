...
class LiveGradingLUTBox:
    ...
    def initialize(self) -> bool:
        ...
        """
        try:
            self.backend = StreamingFactory.create_lut_streamer(self.stream_name, self.lut_size)
    ...
    def get_status(self) -> dict:
        ...
        return {
            ...
            "saturation": self.saturation,
            "backend_initialized": self.backend is not None and self.backend.initialized,
        }
