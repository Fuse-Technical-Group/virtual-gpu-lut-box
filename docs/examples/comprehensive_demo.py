...
def example_texture_formats() -> None:
    ...
    for fmt in formats:
        ...
        print_info(f"{fmt.upper()} format: {texture_data.shape}, range: [{texture_data.min():.3f}, {texture_data.max():.3f}]")
...
def main():
    ...
    try:
        ...
        custom_lut = example_lut_generation()
